 ...
 * -----------------
 * This class is a subclass of the Stanford Graph class.
 * It enables customization of Graph for its implementation
 * in the Pathfinder project.
 *
 * The only additional functionality it is being given is
 *      1.  A method to get an image string
 *      2.  A method to return the image string
 */
